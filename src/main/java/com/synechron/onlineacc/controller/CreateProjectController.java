...
public class CreateProjectController {
	...
	public String createAppsRegular(Model model) {
		L.debug("37 : Start : CreateProjectController.createAppsRegular(...)");
		...
		L.debug("43 : End : CreateProjectController.createAppsRegular(...)");
...
//			Close Ticket
	...
	public String createAppsIntegrationApp(Model model) {
		L.debug("100 : Start : CreateProjectController.createAppsIntegrationApp(...)");
		...
		L.debug("107 : End : CreateProjectController.createAppsIntegrationApp(...)");
